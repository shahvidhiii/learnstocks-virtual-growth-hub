...
const allBasicsQuestions: QuizQuestion[] = [
  { id: "b1", text: "What is a stock?", options: ["A type of bond issued by companies", "A unit of ownership in a company", "A loan given to a company", "A government security"], correctOption: 1, explanation: "A stock represents a share of ownership in a company.", difficulty: "Easy" },
  { id: "b2", text: "What is a bull market?", options: ["A market where stock prices are falling", "A market dominated by aggressive trading", "A market where stock prices are rising", "A market with high volatility"], correctOption: 2, explanation: "A bull market is characterized by a sustained rise in market prices.", difficulty: "Easy" },
  { id: "b3", text: "What is a dividend?", options: ["A fee charged by brokers", "A portion of profits paid to shareholders", "The difference between buy and sell price", "A type of market order"], correctOption: 1, explanation: "A dividend is a distribution of a portion of a company's earnings to its shareholders.", difficulty: "Easy" },
  { id: "b4", text: "What does P/E ratio stand for?", options: ["Profit/Earnings ratio", "Price/Earnings ratio", "Potential/Expected ratio", "Performance/Efficiency ratio"], correctOption: 1, explanation: "Price-to-Earnings (P/E) ratio is a valuation ratio of a company's current share price compared to its per-share earnings.", difficulty: "Medium" },
  { id: "b5", text: "What is market capitalization?", options: ["The total value of a company's assets", "The total value of a company's outstanding shares", "The maximum price of a stock in the past year", "The total debt of a company"], correctOption: 1, explanation: "Market capitalization is the total value of a company's outstanding shares.", difficulty: "Easy" },
  { id: "b6", text: "When you buy one share of a company's stock, you become:", options: ["A partial owner of the company", "A lender to the company", "A company employee", "A mandatory board member"], correctOption: 0, explanation: "Buying one share means you own a fraction of that company.", difficulty: "Easy" },
  { id: "b7", text: "Why do private companies typically decide to go public with an IPO?", options: ["To avoid taxes on profits", "To raise capital for growth and expansion", "To convert to a cooperative", "To limit the number of shareholders"], correctOption: 1, explanation: "The primary reason for an IPO is to raise funds for growth.", difficulty: "Easy" },
  { id: "b8", text: "What happens during a 2-for-1 forward stock split?", options: ["Each existing share is split into 2 shares, halving the price of each share", "Number of shares is cut in half, doubling the price", "Total market value of your holding doubles", "Company issues extra shares as dividends"], correctOption: 0, explanation: "In a stock split, the number of shares increases but the price per share decreases proportionally.", difficulty: "Medium" },
  { id: "b9", text: "Which type of risk can be reduced through diversification of a portfolio?", options: ["Systematic (market) risk", "Unsystematic (company-specific) risk", "Inflation risk", "Currency risk"], correctOption: 1, explanation: "Diversification helps reduce unsystematic risk (company- or sector-specific).", difficulty: "Medium" },
  { id: "b10", text: "Which order type allows you to specify the maximum price you are willing to pay when buying a stock?", options: ["Market order", "Stop order", "Limit order", "Fill-or-kill order"], correctOption: 2, explanation: "A limit order lets you set the maximum buying price (or minimum selling price).", difficulty: "Easy" },
  { id: "b11", text: "Trading on margin means:", options: ["Borrowing funds from a broker to buy securities, magnifying gains and losses", "Trading only government bonds", "Buying stocks with cash only", "Agreeing to hold a stock for at least one year"], correctOption: 0, explanation: "Margin trading involves borrowing money from brokers to buy more shares.", difficulty: "Medium" },
  { id: "b12", text: "The Nifty 50 index represents:", options: ["The 50 most actively traded global stocks", "50 large-cap Indian companies listed on NSE", "50 top-performing startups in India", "The 50 largest banks in India"], correctOption: 1, explanation: "The Nifty 50 tracks 50 large-cap companies across sectors listed on the NSE.", difficulty: "Easy" },
  { id: "b13", text: "What is the main role of SEBI in India?", options: ["To regulate and protect investors in the securities market", "To provide loans to listed companies", "To set interest rates for banks", "To issue government bonds"], correctOption: 0, explanation: "SEBI (Securities and Exchange Board of India) regulates securities markets and safeguards investor interests.", difficulty: "Easy" },
  { id: "b14", text: "Which of the following best describes an ETF (Exchange Traded Fund)?", options: ["A mutual fund that trades on stock exchanges like a stock", "A private loan issued by banks", "A type of government bond", "A company's retained earnings"], correctOption: 0, explanation: "ETFs are investment funds traded on exchanges, combining features of mutual funds and stocks.", difficulty: "Easy" },
  { id: "b15", text: "If a company's share price is ₹100 and it has 1 crore shares outstanding, its market cap is:", options: ["₹10 crores", "₹100 crores", "₹1,000 crores", "₹1 crore"], correctOption: 1, explanation: "Market cap = Price × Outstanding shares = 100 × 1 crore = ₹100 crores.", difficulty: "Easy" },
  { id: "b16", text: "A stock with a beta greater than 1 indicates:", options: ["The stock is less volatile than the market", "The stock moves opposite to the market", "The stock is more volatile than the market", "The stock has no correlation with the market"], correctOption: 2, explanation: "A beta >1 means the stock amplifies market movements, rising or falling more sharply.", difficulty: "Medium" },
  { id: "b17", text: "What is short selling?", options: ["Selling a stock you don't own, hoping to buy it back later at a lower price", "Selling shares immediately after an IPO", "Selling stocks after a dividend is declared", "Selling only penny stocks"], correctOption: 0, explanation: "Short selling involves borrowing shares, selling them, and repurchasing later at (hopefully) a lower price.", difficulty: "Medium" },
  { id: "b18", text: "What is a 'blue-chip stock'?", options: ["High-value government bonds", "Stocks of large, financially stable, and reputable companies", "Stocks that always pay dividends", "Technology sector stocks only"], correctOption: 1, explanation: "Blue-chip stocks are from well-established, financially sound companies with reliable performance.", difficulty: "Easy" },
  { id: "b19", text: "Which financial statement shows a company's assets, liabilities, and equity?", options: ["Cash flow statement", "Balance sheet", "Income statement", "Equity statement"], correctOption: 1, explanation: "The Balance Sheet provides a snapshot of a company's financial position at a single point in time.", difficulty: "Easy" },
  { id: "b20", text: "What is the role of a stock exchange like NSE or BSE?", options: ["To lend money to companies", "To provide a platform for buying and selling securities", "To decide which companies are profitable", "To regulate bank interest rates"], correctOption: 1, explanation: "Exchanges provide the infrastructure and platforms for investors to trade securities.", difficulty: "Easy" },
  { id: "b21", text: "What does liquidity of a stock mean?", options: ["The speed at which it can be bought or sold without affecting its price", "The company's total profits", "Its ability to pay dividends", "The stability of its stock price"], correctOption: 0, explanation: "Liquidity measures how easily an asset can be converted to cash without significant price changes.", difficulty: "Medium" },
  { id: "b22", text: "What does an index fund do?", options: ["Attempts to outperform the market with active management", "Tracks and replicates the performance of a specific market index", "Only invests in Initial Public Offerings (IPOs)", "Invests exclusively in government bonds"], correctOption: 1, explanation: "Index funds aim to mirror the performance of a market index like the Nifty 50 or S&P 500.", difficulty: "Easy" },
  { id: "b23", text: "What is meant by market volatility?", options: ["Changes in interest rates set by the RBI", "The rate and magnitude of stock price fluctuations", "The volume of company earnings reports", "The total number of traded shares"], correctOption: 1, explanation: "Volatility refers to how much and how quickly stock prices move up or down over time.", difficulty: "Easy" },
  { id: "b24", text: "What is a circuit breaker in stock markets?", options: ["A limit placed to temporarily halt trading during extreme price swings", "A device used to prevent power outages at stock exchanges", "A regulatory limit on how many dividends a company can pay", "An order to automatically sell all stocks in a portfolio"], correctOption: 0, explanation: "Circuit breakers are regulatory measures that temporarily halt trading on an exchange to curb panic-selling.", difficulty: "Medium" },
  { id: "b25", text: "What does the term 'insider trading' refer to?", options: ["Legally buying stocks of the company you work for", "Using non-public, confidential information to trade securities", "Trading tips shared by government insiders", "Trading only stocks within your country's borders"], correctOption: 1, explanation: "Insider trading is the illegal practice of trading based on material non-public information.", difficulty: "Easy" },
  { id: "b26", text: "Which index represents the top 30 companies listed on the Bombay Stock Exchange?", options: ["Nifty 50", "BSE Sensex", "Dow Jones Industrial Average", "FTSE 100"], correctOption: 1, explanation: "The Sensex is the benchmark index of the BSE, comprising 30 of the largest and most actively-traded stocks.", difficulty: "Easy" },
  { id: "b27", text: "What is a Demat Account?", options: ["A type of savings account for traders", "An account to hold financial securities in electronic form", "A loan account for buying stocks on margin", "An account for receiving dividends only"], correctOption: 1, explanation: "A Demat (Dematerialized) Account is used to hold shares and securities in an electronic format.", difficulty: "Easy" },
  { id: "b28", text: "What is a 'bear market'?", options: ["A market where prices are expected to rise", "A market where prices have fallen 20% or more from recent highs", "A market with low trading volume", "A market for agricultural commodities"], correctOption: 1, explanation: "A bear market is characterized by prolonged price declines and widespread pessimism.", difficulty: "Easy" },
  { id: "b29", text: "What is an 'arbitrage' opportunity?", options: ["A risky investment in a startup company", "A government-sponsored investment scheme", "Simultaneously buying and selling an asset in different markets to profit from a price difference", "A type of high-frequency trading algorithm"], correctOption: 2, explanation: "Arbitrage exploits small price differences of the same asset in different markets.", difficulty: "Medium" },
  { id: "b30", text: "What is a 'penny stock'?", options: ["A stock that costs exactly one penny", "A stock issued by a new company", "A stock with a very small market capitalization that trades at a low price", "A stock that is guaranteed to increase in value"], correctOption: 2, explanation: "Penny stocks are low-priced, speculative stocks of small companies.", difficulty: "Easy" },
  { id: "b31", text: "What is a rights issue?", options: ["An issue of shares to the general public", "An invitation to existing shareholders to purchase additional new shares", "A legal dispute over share ownership", "The first time a company offers stock"], correctOption: 1, explanation: "A rights issue gives existing shareholders the right to buy new shares, usually at a discount.", difficulty: "Medium" },
...
const allTechnicalQuestions: QuizQuestion[] = [
  ...
  { id: "t31", text: "What is meant by 'divergence'?", options: ["When a stock's price moves in the opposite direction of a technical indicator", "When two stocks in the same sector move in opposite directions", "The difference between a stock's high and low price", "When an analyst's opinion differs from the market consensus"], correctOption: 0, explanation: "For example, a bullish divergence occurs when the stock price makes a new low but the RSI makes a higher low.", difficulty: "Medium" },
  { id: "t32", text: "What is a 'Symmetrical Triangle' pattern?", options: ["A bullish reversal pattern", "A bearish reversal pattern", "A continuation pattern that indicates a period of consolidation before the price moves", "A long-term investment signal"], correctOption: 2, explanation: "A Symmetrical Triangle is formed by converging trend lines and can break out in either direction, though it often continues the prior trend.", difficulty: "Medium" },
  { id: "t33", text: "Which type of chart is most commonly used in technical analysis?", options: ["Pie Chart", "Bar Chart", "Line Chart", "Candlestick Chart"], correctOption: 3, explanation: "Candlestick charts provide the most information, showing the open, high, low, and close prices for a period.", difficulty: "Easy" },
  { id: "t34", text: "The 'Aroon Oscillator' is used to identify:", options: ["Trend direction and strength", "Market volatility", "A company's earnings momentum", "Overbought and oversold levels"], correctOption: 0, explanation: "The Aroon indicator measures the time between highs and the time between lows over a time period.", difficulty: "Difficult" },
  { id: "t35", text: "What is a 'Cup and Handle' pattern?", options: ["A bearish reversal pattern", "A bullish continuation pattern", "A short-term consolidation pattern", "A signal of low liquidity"], correctOption: 1, explanation: "The 'cup' is a 'U' shape and the 'handle' is a slight downward drift, often signaling a breakout to the upside.", difficulty: "Medium" },
  ...
  { id: "t37", text: "In Elliott Wave Theory, a primary upward trend is typically composed of:", options: ["Three impulse waves and two corrective waves", "Two impulse waves and three corrective waves", "Five impulse waves and three corrective waves", "An equal number of impulse and corrective waves"], correctOption: 2, explanation: "This 5-3 pattern forms the basic structure of market movements according to Elliott Wave Theory.", difficulty: "Difficult" },
  { id: "t38", text: "What is a 'Simple Moving Average' (SMA)?", options: ["An average of selected high prices", "An arithmetic mean of a security's prices over a specific period", "A moving average that gives more weight to recent prices", "The average of the open and close price"], correctOption: 1, explanation: "An SMA is calculated by adding the closing prices for a number of periods and then dividing this total by that same number of periods.", difficulty: "Easy" },
  { id: "t39", text: "What is an 'Exponential Moving Average' (EMA)?", options: ["A moving average that gives more weight to recent prices", "A moving average that gives more weight to older prices", "The same as a Simple Moving Average", "An average that predicts future prices"], correctOption: 0, explanation: "An EMA reacts more quickly to recent price changes than an SMA.", difficulty: "Easy" },
  { id: "t40", text: "What does the 'Parabolic SAR' indicator help traders determine?", options: ["The potential direction of momentum and points where it might reverse", "The market capitalization of a stock", "The fair value of a stock", "The volume of trades"], correctOption: 0, explanation: "SAR stands for 'Stop and Reverse'. The indicator appears as dots above or below the price.", difficulty: "Medium" },
  { id: "t41", text: "A 'Descending Triangle' is typically what kind of pattern?", options: ["Bullish reversal", "Bearish continuation", "Bullish continuation", "Neutral"], correctOption: 1, explanation: "It's characterized by a flat support line and a descending resistance line, suggesting selling pressure is increasing.", difficulty: "Medium" },
  { id: "t42", text: "What is a 'fill or kill' order?", options: ["An order that must be executed immediately in its entirety or canceled", "An order that can be partially filled", "An order that stays active for the entire day", "An order to buy at any price"], correctOption: 0, explanation: "This order type is used when a trader wants to ensure a large order is filled at a specific price without partial execution.", difficulty: "Medium" },
  { id: "t43", text: "What does the term 'Gann Angles' refer to?", options: ["A method of calculating a company's profit angles", "Geometric angles used to predict price movements based on time and price relationships", "A type of chart pattern", "A risk management technique"], correctOption: 1, explanation: "Developed by W.D. Gann, these angles are drawn on a chart to provide support and resistance lines.", difficulty: "Difficult" },
...
const getDailyRandomQuestions = (allQuestions: QuizQuestion[], quizId: string, count: number, userId?: string) => {
  ...
  const selected: QuizQuestion[] = [];
    ...
    if (count >= 3) {
      const difficulties: ("Easy" | "Medium" | "Difficult")[] = ["Easy", "Medium", "Difficult"];
    ...
    const remaining = Object.values(pools).flat().concat(
    ...
    if (selected.length < count) {
      ...
      for (const q of fill) {
        if (selected.length >= count) break;
        if (!selected.find((s) => s.id === (q as any).id)) selected.push(q as QuizQuestion);
      }
    }
...
const Games = () => {
  ...
  const handleStartQuiz = (quiz: Quiz) => {
    ...
    const allQuestionsForQuiz = quiz.id === "basics" 
      ? allBasicsQuestions 
